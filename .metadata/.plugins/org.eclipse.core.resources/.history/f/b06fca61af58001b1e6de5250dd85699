	...
	<div class="container-md w-75">
		...
		<form action="/aulas/reservaUnitaria" method="GET">
			<div class="form-group">
				<label for="cod_tipord">Usuario: ${usuario}</label>
				<input type="text" class="invisible" name="usuario" value="${usuario}">
			</div>
			<div class="form-group">
				<label for="cod_tipord">Aulas</label> 
	            <select class="form-control-rosa" name="codAulaSelec" required>
	            	<c:forEach items="${allAulas}" var="aula">
