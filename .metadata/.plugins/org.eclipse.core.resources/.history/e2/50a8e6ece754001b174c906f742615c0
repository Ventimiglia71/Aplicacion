...
<head>
    ...
    <link rel="stylesheet" href="./css/calendario.css"></head>
	<script>
		function volver(){
...
<body>
	...
	<div class="colorCabecera partir85 centrado">
		<div class="partirNo titulo centrado">${mesNombre}</div>
		<div class="partirNo espacioGrande"><p></p></div>
		<div class="partir5_5"><p></p></div>
		<div class="partir5 colorEjes centrado">9:00</div>
		<div class="partir2"><p></p></div>
		<div class="partir5 colorEjes centrado">10:00</div>
		<div class="partir2"><p></p></div>
		<div class="partir5 colorEjes centrado">11:00</div>
		<div class="partir2"><p></p></div>
		<div class="partir5 colorEjes centrado">12:00</div>
		<div class="partir2"><p></p></div>
		<div class="partir5 colorEjes centrado">13:00</div>
		<div class="partir2"><p></p></div>
		<div class="partir5 colorEjes centrado">14:00</div>
		<div class="partir2"><p></p></div>
		<div class="partir5 colorEjes centrado">15:00</div>
		<div class="partir2"><p></p></div>
		<div class="partir5 colorEjes centrado">16:00</div>
		<div class="partir2"><p></p></div>
		<div class="partir5 colorEjes centrado">17:00</div>
		<div class="partir2"><p></p></div>
		<div class="partir5 colorEjes centrado">18:00</div>
		<div class="partir2"><p></p></div>
		<div class="partir5 colorEjes centrado">19:00</div>
		<div class="partir2"><p></p></div>
		<div class="partir5 colorEjes centrado">20:00</div>
		<div class="partir2"><p></p></div>
		<div class="partir5 colorEjes centrado">21:00</div>
		<div class="partir5_5"><p></p></div>
	
		<c:forEach begin="1" end="${diasMes}" var="i">
			<div class="partirNo espacioPeq"><p></p></div>
			<div class="partir1_5"><p></p></div>
			<div class="partir2 colorEjes centrado">${i}</div>
			<c:forEach begin="1" end="13" var="j">
				<div class="partir2"><p></p></div>
				<c:choose>
					<c:when test="${reservado[i][j] == true}">
						<div class="partir5 colorReserva"><p></p></div>
					</c:when>
					<c:otherwise>
						<div class="partir5 colorLibre"><p></p></div>
					</c:otherwise>
				</c:choose>
			</c:forEach>
			<div class="partir5_5"><p></p></div>
