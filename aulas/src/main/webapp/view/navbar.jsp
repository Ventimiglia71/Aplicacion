    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown"><a
                ...
                <div class="dropdown-menu darkBG" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="/hoteleclipse/admin/findAllHabitaciones">Consulta</a>
                    <a class="dropdown-item" href="/hoteleclipse/admin/inicioCrearHabitacion">Reserva</a>
                </div>
            </li>
        </ul>
        <form action="/aulas/preConsulta" method="GET" class="form-inline my-2 my-lg-0">
